...
public class VoxelTile : MonoBehaviour
{
    ...
    public int TileHeightVoxels = 10;
    ...
    {
        ColorsRight = new int[TileHeightVoxels * TileSideVoxels];
        ColorsForward = new int[TileHeightVoxels * TileSideVoxels];
        ColorsLeft = new int[TileHeightVoxels * TileSideVoxels];
        ColorsBack = new int[TileHeightVoxels * TileSideVoxels];

        for (int y = 0; y < TileHeightVoxels; y++)
        {
    ...
    public void Rotate90()
    {
        ...
        int[] colorsRightNew = new int[TileHeightVoxels * TileSideVoxels];
        int[] colorsForwardNew = new int[TileHeightVoxels * TileSideVoxels];
        int[] colorsLeftNew = new int[TileHeightVoxels * TileSideVoxels];
        int[] colorsBackNew = new int[TileHeightVoxels * TileSideVoxels];

        for (int layer = 0; layer < TileHeightVoxels; layer++)
        {
